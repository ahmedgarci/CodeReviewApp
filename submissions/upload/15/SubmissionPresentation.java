...
import com.example.CodeReviewApp.dto.Reviews.In.PublishReviewDto;
...
public class SubmissionPresentation {
    ...
    public ResponseEntity<byte[]> getFileContent(@PathVariable Long submissionId,@PathVariable Long fileId) {
