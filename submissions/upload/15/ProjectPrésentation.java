...
import com.example.CodeReviewApp.dto.Project.Out.ProjectCollaborator;
...
public class ProjectPrésentation {
    ...
    public ResponseEntity<List<ProjectCollaborator>> getProjectCollab(@PathVariable(name = "ProjectId") Long ProjectId) {
